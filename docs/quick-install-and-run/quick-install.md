...
-   Run the install script:
          ...
          *./plan4res_install.sh* with needed options  (-S \$SOLVER with \$SOLVER=CPLEX, GUROBI, SCIP ; else it will use
    HiGHS ; -I \$installer if \$SOLVER is CPLEX or GUROBI; -L \$LICENCE if \$SOLVER is GUROBI; ....)
